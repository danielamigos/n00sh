<?php /* Template Name: Product Template */ get_header(); ?>
    ...
    <div class="row first-level-row" >
        ...
        <div class="col-xs-12 col-sm-6 first-level-solid-column-right" <?PHP //style="padding-right:12px; padding-bottom:12px;" ?> >
            <img alt="image1" src="<?php echo get_template_directory_uri(); ?>/img/noosh-product-img-2.jpg" style="width:100%"/>
        </div>
    </div>
            ...
            <div class="row second-level-row">
                <div class="col-xs-12 h-xs-6" >
                    <div class="second-level-vertical-stack-right second-level-vertical-stack-top"  <?php //style="padding-left:12px; padding-bottom:12px;"?> >                        
                        <img alt="image1" src="<?php echo get_template_directory_uri(); ?>/img/noosh-product-img-3.jpg" style="width:100%"/>
                    </div>
                </div>
            </div>
    ...
    <div class="row first-level-row" <?php //style="padding-top:12px;"?> >
        ...
        <div class="col-xs-12 col-sm-9 first-level-solid-column-right"  <?php //sstyle="padding-left:12px; padding-bottom:12px;"?> >
            <img alt="image7" src="<?php echo get_template_directory_uri(); ?>/img/noosh-product-img-4.jpg"  style="width:100%"/>
        </div>
    </div>
